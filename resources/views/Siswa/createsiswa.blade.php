  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info card-outline">
        ...
        <form action="{{ route('simpansiswa')}}" method="post">
          ...
          <div class="form-group">
            <input type="date" id="tgllhr" name="tgllhr" class="form-control" placeholder="Tanggal Lahir Siswa">
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success mb-2">Simpan Data</button>
